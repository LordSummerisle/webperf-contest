...
// CSS specific configuration ///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	private $css_datauri_ignore = array("spt-ong2-chaines-o-png8");
...
// Start of functions ///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	private function errorcheck()
	{
		...
		/**
		* This function check if the name in parameter contains one of the keywords of $this->css_datauri_ignore
		*/
		private function ignore_image($var) {
//		echo $var."LOL";

		foreach($this->css_datauri_ignore as $keyword) {
	...
	*/
	protected function css_datauri($filescontent = '',$dir = '')
	{
		...
		if($this->css_mhtml_enabled_ie)
		{
			...
			$treffer[0] = array_filter($treffer[0], array($this, 'ignore_image'));
