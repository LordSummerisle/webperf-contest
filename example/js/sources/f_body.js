...
$(function () {
	...
	if ($('#banner186756').attr('src')!=='http://webperf-contest.com/example/img/186x756_25082010.gif')
		setTimeout("$('#banner186756').attr('src','http://webperf-contest.com/example/img/186x756_25082010.gif')",2000);
});
}
